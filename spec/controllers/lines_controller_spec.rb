  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved line as @line" do
        ...
        post :create, {:line => { "lot_id" => "invalid value" }}, valid_session
        assigns(:line).should be_a_new(Line)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested line" do
        ...
        Line.any_instance.should_receive(:update).with({ "lot_id" => "1" })
        put :update, {:id => line.to_param, :line => { "lot_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the line as @line" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Line.any_instance.stub(:save).and_return(false)
        put :update, {:id => line.to_param, :line => { "lot_id" => "invalid value" }}, valid_session
        assigns(:line).should eq(line)
      end
