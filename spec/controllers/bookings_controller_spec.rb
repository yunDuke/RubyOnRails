...
describe BookingsController do
  ...
  let(:valid_attributes) { { "carplate" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved booking as @booking" do
        ...
        post :create, {:booking => { "carplate" => "invalid value" }}, valid_session
        assigns(:booking).should be_a_new(Booking)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested booking" do
        ...
        Booking.any_instance.should_receive(:update).with({ "carplate" => "MyString" })
        put :update, {:id => booking.to_param, :booking => { "carplate" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the booking as @booking" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Booking.any_instance.stub(:save).and_return(false)
        put :update, {:id => booking.to_param, :booking => { "carplate" => "invalid value" }}, valid_session
        assigns(:booking).should eq(booking)
      end
